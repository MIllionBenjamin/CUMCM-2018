...
for q in range(1, 254 + 1):
    for r in range(0, 8):
        genome.append(int(genesequence[q][r]))
    print(genome)
    allgeneseq.append(genesequence[q])
...
print(max(allgoodsnum))
print(allgeneseq[allgoodsnum.index(max(allgoodsnum))])
